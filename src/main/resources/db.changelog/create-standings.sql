...
CREATE TABLE IF NOT EXISTS transfers_stats
(
    player     CHARACTER VARYING(100) PRIMARY KEY,
    games      INTEGER,
    goals      INTEGER,
...
CREATE TABLE IF NOT EXISTS statsbrhl
(
    player     CHARACTER VARYING(100) PRIMARY KEY,
    games      INTEGER,
    goals      INTEGER,
...
CREATE TABLE IF NOT EXISTS goalie_statsbrhl
(
    player          CHARACTER VARYING(100) PRIMARY KEY,
    games           INTEGER,
    shots_against   INTEGER,
...
CREATE TABLE IF NOT EXISTS team_statsbrhl
(
    team                      CHARACTER VARYING(100) PRIMARY KEY,
    onetimer_shots            INTEGER,
    onetimer_goals            INTEGER,
...
CREATE TABLE IF NOT EXISTS defenseman_statsbrhl
(
    player     CHARACTER VARYING(100) PRIMARY KEY,
    games      INTEGER,
    goals      INTEGER,
